(function () {
  ...
  ready(function () {
    document
      .querySelectorAll("[data-counterpilot-open]")
    ...
    document
      .querySelectorAll("[data-counterpilot-form]")
      .forEach(function (form) {
        form.addEventListener("submit", function (event) {
          var root = form.closest(".counterpilot-offer");
          var endpoint =
            root && root.getAttribute("data-counterpilot-offer-endpoint");
          ...
          fetch(endpoint, {
            ...
            .then(function (body) {
              ...
              form.dispatchEvent(
                new CustomEvent("counterpilot:offer-submitted", {
                  bubbles: true,
                  detail: {
            ...
            .catch(function (error) {
              setStatus(
                form,
                error.message || "Offer submission failed.",
                true,
              );
            })
            .finally(function () {
