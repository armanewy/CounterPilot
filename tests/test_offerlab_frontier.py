...
class OfferLabFrontierTests(unittest.TestCase):
    def test_frontier_is_predictive_support_bound_and_not_profit_optimization(self) -> None:
        ...
        self.assertNotIn("row_id", supported[0]["nearest_comparable_counters"][0])
        self.assertNotIn("label", supported[0]["nearest_comparable_counters"][0])
        self.assertIn("case_token", supported[0]["nearest_comparable_counters"][0])
